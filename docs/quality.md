...
- Playwright runs `@axe-core/playwright` against the public landing page, sign-in, dashboard, projects, project/task dialogs, and the board using WCAG 2.0/2.1 A and AA rules.
