...
The quick-add form creates a task from the board header with only a title, status, and priority. The full task dialog remains available for descriptions, assignees, due dates, and labels.
